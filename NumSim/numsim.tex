...
\begin{frame}{The Challenge: A Flexible Interface to a Complex Model}
  \input{schematic}
  \begin{itemize}
    \item Need: Compute dynamics of electron pulse ($w(t)$, $l(t)$)
    \item Note: Generation and optical elements add terms to DE
    \item Want: Representitive OO user-level interface
  \end{itemize}
\end{frame}
